...
/*
 * A simple HTTP server specialized for OpenNovel.
 */
...
int main(int argc, char *argv[])
{
	...
	snprintf(req_data, sizeof(req_root), "GET /%d/package.pak HTTP/1.1", random_dir_number);
	...
	while (1) {
		...
		if (strcmp(fname, "index.html") == 0) {
			...
			is_wasm_sent = 1;
		} else if (strcmp(fname, "package.pak") == 0) {
