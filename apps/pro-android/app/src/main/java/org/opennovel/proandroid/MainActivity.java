...
public class MainActivity extends ComponentActivity {
    ...
    public static final String APP_NAME = "OpenNovel";

    // JNI
    static {
        // Load libopennovel.so and native*() methods will be available.
            ...
            new ActivityResultCallback<Uri>() {
                ...
                public void onActivityResult(Uri uri) {
                    if (uri != null) {
                        ...
                        // Append the "OpenNovel" directory path/
                        if (!basePath.endsWith("/OpenNovel"))
                            basePath = basePath + "/OpenNovel/";
                        else
                            basePath = basePath + "/";
                        ...
                        // Initialize the OpenNovel in the rendering thread.
