...
#ifndef OPENNOVEL_STAGE_H
#define OPENNOVEL_STAGE_H
...
/*
 * System Button Rendering and Pointing Check
 */

/* Render the system button. */
void render_sysbtn(bool is_pointed);

/* Checks if the system button is pointed. */
...
/* Draw switch images into the save data thumbnail */
