 ...
 */
#if defined(OPENNOVEL_TARGET_ANDROID)
#include <GLES3/gl3.h>
 ...
 */
#if defined(OPENNOVEL_TARGET_SDL2)
#include <GL/gl.h>
#include "glhelper.h"
#endif
 ...
 */
#if defined(OPENNOVEL_TARGET_POSIX)
#include <GL/gl.h>
#include "glhelper.h"
#endif
 ...
 */
#if defined(OPENNOVEL_TARGET_MACOS)
...
#if !defined(OPENNOVEL_TARGET_WASM) && !defined(OPENNOVEL_TARGET_MACOS)
	"#version 100                 \n"
#endif
...
/*
 * Initialize the OpenNovel's OpenGL rendering subsystem.
 */
bool init_opengl(void)
{
#ifdef OPENNOVEL_TARGET_ANDROID
	cleanup_opengl();
#endif

	/* Set a viewport. */
	glViewport(0, 0, conf_game_width, conf_game_height);
...
/*
 * Cleanup the OpenNovel's OpenGL rendering subsystem.
 ...
 *  - OpenNovel abstracts modifications of textures by "notify" operations.
			     ...
			     int pipeline)
{
	...
	/* ウィンドウサイズの半分を求める */
	hw = (float)conf_game_width / 2.0f;
	hh = (float)conf_game_height / 2.0f;
