...
#ifndef OPENNOVEL_GLHELPER_H
#define OPENNOVEL_GLHELPER_H
 ...
 */
#if (defined(OPENNOVEL_TARGET_POSIX) && !defined(USE_QT)) || defined(OPENNOVEL_TARGET_WIN32)
...
#endif
#endif /* if defined(OPENNOVEL_TARGET_WIN32) || (defined(LINUX) && !defined(USE_QT) */
