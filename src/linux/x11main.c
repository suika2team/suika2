...
static bool create_window(void)
{
	...
	ret = XmbTextListToTextProperty(display, &conf_game_title, 1, XCompoundTextStyle, &tp);
	...
	sh->min_width = conf_game_width;
	sh->min_height = conf_game_height;
	sh->max_width = conf_game_width;
	sh->max_height = conf_game_height;
