...
Java_com_opennovel_proandroid_MainActivity_nativeInitGame(
	JNIEnv *env,
	jobject instance,
	jstring basePath)
{
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeReinitOpenGL(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeRunFrame(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
	...
	bool draw = true;
	if (state_video) {
		jclass cls = (*jni_env)->FindClass(jni_env, "com/opennovel/proandroid/MainActivity");
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeOnPause(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeOnResume(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeOnTouchStart(
        JNIEnv *env,
        jobject instance,
        jint x,
        jint y,
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeOnTouchMove(
	JNIEnv *env,
	jobject instance,
	jint x,
	jint y)
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeOnTouchEnd(
	JNIEnv *env,
	jobject instance,
	jint x,
	jint y,
...
Java_com_opennovel_proandroid_MainActivity_nativeGetIntConfigForKey(
	JNIEnv *env,
	jobject instance,
	jstring key)
{
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeSetContinueFlag(
	JNIEnv *env,
	jobject instance)
{
	flag_continue = true;
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeSetNextFlag(
	JNIEnv *env,
	jobject instance)
{
	flag_next = true;
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeSetStopFlag(
	JNIEnv *env,
	jobject instance)
{
	flag_stop = true;
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeSetOpenFlag(
	JNIEnv *env,
	jobject instance,
	jstring file)
{
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeSetLineFlag(
	JNIEnv *env,
	jobject instance,
	jint line)
{
...
JNIEXPORT void JNICALL
Java_com_opennovel_proandroid_MainActivity_nativeSaveScript(
	JNIEnv *env,
	jobject instance,
	jint line)
{
...
Java_com_opennovel_proandroid_MainActivity_nativeUpdateScriptModel(
	JNIEnv *env,
	jobject instance,
	jstring script)
{
...
Java_com_opennovel_proandroid_MainActivity_nativeGetScript(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
...
bool log_info(const char *s, ...)
{
	...
	__android_log_print(ANDROID_LOG_INFO, "OpenNovel", "%s", buf);
	va_end(ap);
...
bool log_warn(const char *s, ...)
{
	...
	va_start(ap, s);
	vsnprintf(buf, sizeof(buf), s, ap);
	__android_log_print(ANDROID_LOG_WARN, "OpenNovel", "%s", buf);
	va_end(ap);
...
bool log_error(const char *s, ...)
{
	...
	va_start(ap, s);
	vsnprintf(buf, sizeof(buf), s, ap);
	__android_log_print(ANDROID_LOG_ERROR, "OpenNovel", "%s", buf);
	va_end(ap);
