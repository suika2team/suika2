...
$CC -I. -I./src -fPIC $CFLAGS -std=c89 -Wno-deprecated-non-prototype -c inflate.c
...
$CC -fPIC $CFLAGS -c jmemname.c -Wno-implicit-function-declaration
...
$CC -DFT2_BUILD_LIBRARY -I./include -I$PREFIX/include -fPIC $CFLAGS -c src/gzip/inflate.c -Wno-implicit-function-declaration -Dft_memcpy=memcpy
